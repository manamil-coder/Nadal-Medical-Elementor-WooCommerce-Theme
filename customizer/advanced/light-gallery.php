...
Medizin_Kirki::add_field( 'theme', array(
	...
	'choices'  => array(
		...
		'secondary' => esc_html__( 'Secondary', 'medizin' ),
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'label'           => esc_html__( 'Custom Background Color', 'medizin' ),
	'section'         => $section,
	'priority'        => $priority ++,
	'transport'       => 'auto',
	'default'         => '#000',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'label'    => esc_html__( 'Download Button', 'medizin' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '1',
	'choices'  => array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'label'    => esc_html__( 'Full Screen Button', 'medizin' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '1',
	'choices'  => array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'label'    => esc_html__( 'Share Button', 'medizin' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '1',
	'choices'  => array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'label'    => esc_html__( 'Zoom Buttons', 'medizin' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '1',
	'choices'  => array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'label'    => esc_html__( 'Thumbnail Gallery', 'medizin' ),
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '1',
	'choices'  => array(
