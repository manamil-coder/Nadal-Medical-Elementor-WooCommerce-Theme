...
Medizin_Kirki::add_field( 'theme', array(
	'type'        => 'radio-buttonset',
	'settings'    => $prefix . 'search_categories_enable',
	'label'       => esc_html__( 'Search content type', 'medizin' ),
	'description' => esc_html__( 'Turn on this option if you want to show categories select box', 'medizin' ),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => '1',
	'choices'     => array(
...
Medizin_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'phone_number_text',
	'label'    => esc_html__( 'Phone Number Text', 'medizin' ),
	'section'  => $section,
	'priority' => $priority++,
) );
...
Medizin_Kirki::add_field( 'theme', array(
	'type'     => 'text',
	'settings' => $prefix . 'phone_number_link',
	'label'    => esc_html__( 'Phone Number Link', 'medizin' ),
	'section'  => $section,
	'priority' => $priority++,
) );
...
Medizin_Kirki::add_field( 'theme', array(
	'type'        => 'color-alpha',
	'settings'    => $prefix . 'bottom_background',
	'label'       => esc_html__( 'Background Color', 'medizin' ),
	'description' => esc_html__( 'Controls the background color of header bottom.', 'medizin' ),
	'section'     => $section,
	'priority'    => $priority++,
	'transport'   => 'auto',
	'default'     => '#415DA1',
	'output'      => array(
		array(
			'element'  => '.header-03.header-dark .page-header-bottom',
			'property' => 'background-color',
		),
	),
) );
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '03', 'dark', false, true ),
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '03', 'dark', true, true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '03', 'dark', false ),
	'active_callback' => array(
		array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '03', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '03', 'light', false ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '03', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '03', 'light', false ),
	'active_callback' => array(
		array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '03', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
