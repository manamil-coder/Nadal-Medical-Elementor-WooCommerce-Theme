...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '04', 'dark', false ),
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '04', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '04', 'dark', false ),
	'active_callback' => array(
		array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '04', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '04', 'light', false ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_search_form_kirki_output( '04', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '04', 'light', false ),
	'active_callback' => array(
		array(
...
Medizin_Kirki::add_field( 'theme', array(
	...
	'output'          => Medizin_Header::instance()->get_button_kirki_output( '04', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
