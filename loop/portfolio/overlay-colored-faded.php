<?php
$colored_bg = Medizin_Portfolio::instance()->get_the_post_meta( 'portfolio_overlay_colored_faded_background' );
$style      = '';

$overlay_content_extra_class = '';
if ( ! empty( $colored_bg ) ) {
	$colored_text_skin = Medizin_Portfolio::instance()->get_the_post_meta( 'portfolio_overlay_colored_faded_text_skin' );
...
<div class="post-overlay-content<?php echo esc_attr( $overlay_content_extra_class ); ?>">
	<div class="post-overlay-content-inner">
		<div class="post-overlay-info">
			<?php
			Medizin_Portfolio::instance()->the_categories_no_link( array(
