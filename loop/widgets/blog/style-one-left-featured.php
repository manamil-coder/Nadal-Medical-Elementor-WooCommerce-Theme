...
?>
<?php while ( $medizin_query->have_posts() ) : $medizin_query->the_post(); ?>
	<?php if ( $loop_count === 0 ) : ?>
		<?php ob_start(); ?>
			...
			<div class="post-wrapper medizin-box">
				<div class="post-feature post-thumbnail medizin-image">
					<a href="<?php the_permalink(); ?>" class="link-secret">
						<?php \Medizin_Image::the_post_thumbnail( [
							'size' => '570x330',
						] ); ?>
				...
				<div class="post-caption">
					...
					<?php
					$read_more_text = ! empty( $settings['read_more_text'] ) ? $settings['read_more_text'] : esc_html__( 'Read more', 'medizin' );
...
<div class="row row-no-gutter">
	<div class="col-md-6 featured-post">
		<?php Medizin_Helper::e( $left_box_template ); ?>
	</div>
	<div class="col-md-6 normal-posts">
		<?php Medizin_Helper::e( $right_box_template ); ?>
	</div>
</div>
