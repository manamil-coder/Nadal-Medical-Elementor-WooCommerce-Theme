...
if ( ! class_exists( 'Medizin_Footer' ) ) {

	class Medizin_Footer {
		...
		function popup_search() {
			$enable = Medizin_Global::instance()->get_popup_search();
			if ( $enable !== true ) {
				return;
			}
			?>
		...
		function mobile_menu_logo() {
			$mobile_logo = Medizin::setting( 'mobile_menu_logo' );
			$logo_width  = Medizin::setting( 'mobile_logo_width' );

			if ( isset( $mobile_logo['id'] ) ) {
				$logo_url = Medizin_Image::get_attachment_url_by_id( array(
					'id'   => $mobile_logo['id'],
			...
			<div id="page-off-sidebar" class="page-off-sidebar">
				<div class="inner">
					...
					<div class="page-off-sidebar-content">
						<?php Medizin_Templates::generated_sidebar( 'off_sidebar' ); ?>
					</div>
				</div>
			</div>
			<?php
			...
			<div id="page-mobile-main-menu" class="page-mobile-main-menu">
				<div class="inner">
					...
					<div class="page-mobile-menu-content">
						<?php Medizin::menu_mobile_primary(); ?>
					</div>
				</div>
			</div>
			<?php
		...
		function scroll_top() {
			?>
			<?php if ( Medizin::setting( 'scroll_top_enable' ) ) : ?>
	...
	Medizin_Footer::instance()->initialize();
}
