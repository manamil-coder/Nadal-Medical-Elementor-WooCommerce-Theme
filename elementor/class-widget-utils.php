...
class Widget_Utils {
	...
	public static function get_control_options_horizontal_alignment_full() {
		return [
			...
			'stretch' => [
				'title' => esc_html__( 'Stretch', 'medizin' ),
	...
	public static function get_control_options_text_align_full() {
		return [
			...
			'justify' => [
				'title' => esc_html__( 'Justified', 'medizin' ),
	...
	public static function get_button_style() {
		return [
			...
			'border'       => esc_html__( 'Border', 'medizin' ),
			'thick-border' => esc_html__( 'Thick Border', 'medizin' ),
			'text'         => esc_html__( 'Text', 'medizin' ),
			'bottom-line'  => esc_html__( 'Bottom Line', 'medizin' ),
			'left-line'    => esc_html__( 'Left Line', 'medizin' ),
		];
	}
	...
	public static function get_grid_metro_size() {
		return [
			'1:1'   => esc_html__( 'Width 1 - Height 1', 'medizin' ),
			'1:2'   => esc_html__( 'Width 1 - Height 2', 'medizin' ),
			'1:0.7' => esc_html__( 'Width 1 - Height 70%', 'medizin' ),
			'1:1.3' => esc_html__( 'Width 1 - Height 130%', 'medizin' ),
			'2:1'   => esc_html__( 'Width 2 - Height 1', 'medizin' ),
			'2:2'   => esc_html__( 'Width 2 - Height 2', 'medizin' ),
		];
	}
}
