...
class Group_Control_Advanced_Border extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['type'] = [
			'label'     => _x( 'Type', 'Border Control', 'medizin' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				''       => __( 'Default', 'medizin' ),
				'none'   => __( 'None', 'medizin' ),
				'solid'  => _x( 'Solid', 'Border Control', 'medizin' ),
				'double' => _x( 'Double', 'Border Control', 'medizin' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'medizin' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'medizin' ),
				'groove' => _x( 'Groove', 'Border Control', 'medizin' ),
			],
			'selectors' => [
		...
		$fields['color'] = [
			'label'     => _x( 'Color', 'Border Control', 'medizin' ),
		...
		$fields['width'] = [
			'label'      => _x( 'Width', 'Border Control', 'medizin' ),
		...
		$fields['radius'] = [
			'label'      => _x( 'Rounded', 'Border Control', 'medizin' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Border', 'Advanced Border Control', 'medizin' ),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
