...
class Modify_Widget_Section extends Modify_Base {
	...
	public function section_layout( $element ) {
		...
		$section_gap['options'] = [
			...
			'default'  => esc_html__( 'Normal', 'medizin' ),
			'no'       => esc_html__( 'No Gap', 'medizin' ),
			'narrow'   => esc_html__( 'Narrow', 'medizin' ),
			'extended' => esc_html__( 'Extended', 'medizin' ),
			'wide'     => esc_html__( 'Wide', 'medizin' ),
			'wider'    => esc_html__( 'Wider', 'medizin' ),
		...
		$element->add_control( 'gap_beside', [
			'label'        => esc_html__( 'Gap Beside', 'medizin' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'yes',
			'options'      => [
				'no'  => esc_html__( 'No', 'medizin' ),
				'yes' => esc_html__( 'Yes', 'medizin' ),
			],
		...
		$element->add_responsive_control( 'gap_width', [
			'label'     => esc_html__( 'Gap Width', 'medizin' ),
		...
		$element->add_control( 'column_vertical_alignment', [
			'label'                => esc_html__( 'Column Vertical Alignment', 'medizin' ),
			'label_block'          => true,
			'type'                 => Controls_Manager::CHOOSE,
