...
abstract class Base extends Widget_Base {
	...
	public function get_icon() {
		return 'medizin-badge ' . $this->get_icon_part();
	}
	...
	protected function register_common_button_style_section() {
		...
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [
			...
			'selector' => '{{WRAPPER}} .medizin-box:hover div.tm-button, {{WRAPPER}} a.tm-button:hover',
		] );
		...
		$this->add_group_control( Group_Control_Text_Gradient::get_type(), [
			...
			'selector' => '{{WRAPPER}} .medizin-box:hover div.tm-button .button-text, {{WRAPPER}} a.tm-button:hover .button-text',
		] );
		...
		$this->add_group_control( Group_Control_Text_Gradient::get_type(), [
			...
			'selector'  => '{{WRAPPER}} .medizin-box:hover div.tm-button .button-icon, {{WRAPPER}} a.tm-button:hover .button-icon',
			'condition' => $icon_condition,
		] );
