(
	function( $ ) {
		...
		var MedizinFlipBoxHandler = function( $scope, $ ) {
			var $element = $scope.find( '.medizin-flip-box' );
		...
		$( window ).on( 'elementor/frontend/init', function() {
			elementorFrontend.hooks.addAction( 'frontend/element_ready/tm-flip-box.default', MedizinFlipBoxHandler );
		} );
	}
)( jQuery );
