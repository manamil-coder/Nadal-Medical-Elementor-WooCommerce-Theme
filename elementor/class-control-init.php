...
class Control_Init {
	...
	public function initialize() {
		require_once MEDIZIN_ELEMENTOR_DIR . '/class-font-awesome-pro.php';
		require_once MEDIZIN_ELEMENTOR_DIR . '/class-font-elementor.php';
	...
	public function add_custom_shape_divider( $additional_shapes ) {
		$additional_shapes['center-curve'] = [
			'title'        => esc_html__( 'Curve Alt', 'medizin' ),
			'has_negative' => true,
			'height_only'  => true,
		...
		$additional_shapes['tilt-curve'] = [
			'title'       => esc_html__( 'Tile Curve', 'medizin' ),
			'has_flip'    => true,
			'height_only' => true,
		...
		$additional_shapes['mountain-alt'] = [
			'title'       => esc_html__( 'Mountain Alt', 'medizin' ),
			'has_flip'    => true,
			'height_only' => true,
	...
	public function add_custom_entrance_animations( $animations ) {
		$animations['By Medizin'] = [
			'tmFadeInUp' => 'Medizin - Fade In Up',
		];
	...
	public function init_controls( $controls_manager ) {
		...
		require_once MEDIZIN_ELEMENTOR_DIR . '/controls/group-control-text-gradient.php';
		require_once MEDIZIN_ELEMENTOR_DIR . '/controls/group-control-text-stroke.php';
		require_once MEDIZIN_ELEMENTOR_DIR . '/controls/group-control-advanced-border.php';
		require_once MEDIZIN_ELEMENTOR_DIR . '/controls/group-control-button.php';
		require_once MEDIZIN_ELEMENTOR_DIR . '/controls/group-control-tooltip.php';
