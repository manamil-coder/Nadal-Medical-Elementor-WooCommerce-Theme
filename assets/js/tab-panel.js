jQuery( document ).ready( function( $ ) {
	...
	$( '.medizin-tabpanel' ).each( function( index, element ) {
		var $el = $( this );
		var $navTabs = $( this ).children( '.medizin-nav-tabs' );
		var $contentTabs = $( this ).children( '.medizin-tab-content' );
		var currentTab = 0;
		...
		$el.children( '.medizin-nav-tabs' ).on( 'click', 'a', function( e ) {
			e.preventDefault();
