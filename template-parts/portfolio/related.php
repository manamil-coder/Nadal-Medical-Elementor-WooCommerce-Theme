<?php
$number_post = Medizin::setting( 'portfolio_related_number' );
$results     = Medizin_Portfolio::instance()->get_related_items( array(
	'post_id'      => get_the_ID(),
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="related-portfolio-title">
						<?php echo Medizin::setting( 'portfolio_related_title' ); ?>
					</h3>
												...
												<a href="<?php the_permalink(); ?>" class="post-permalink">
													<div class="post-thumbnail">
														...
														if ( has_post_thumbnail() ) {
															Medizin_Image::the_post_thumbnail( array( 'size' => '480x480' ) );
														} else {
															Medizin_Templates::image_placeholder( 480, 480 );
														}
